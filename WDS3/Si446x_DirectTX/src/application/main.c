/*! @file main.c
 * @brief The main.c file of the Direct Transmit demo for Si446x devices.
 *
...
void main(void)
{
  ...
  // Start Transmitting
  // ------------------
  // The TX Clock output and TX Data input has been set
  // during the radio initialization. The GPIO configuration
  // located in the configuration array.
