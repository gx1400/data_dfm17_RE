...
| 03 | 0x0000a024 | 08 | EA 3F B9 E8 8B A9 CA D6 | PATCH_DATA, A = 0b1010|
...
| 58 | 0x0000a212 | 08 | 13 10 0F 07 04 00 0B 00 | GPIO_PIN_CFG, GPIO0 TX_DATA_CLK for TX Direct Synchronous Mode, GPIO1 EN_PA (HIGH when PA enabled), GPIO2 DIV_CLK, GPIO3 input (for TX data?), do nothing to NIRQ , SDO is outputs SDO,  |
| 59 | 0x0000a21b | 06 | 11 00 02 00 62 60       | SET_PROPERTY, Grp 00, Prop 00-01: GLOBAL_XO_TUNE & GLOBAL_CLK_CFG |
